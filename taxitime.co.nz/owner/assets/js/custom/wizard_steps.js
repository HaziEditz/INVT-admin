...
; (function ($, undefined) {
    ...
    function DecreaseCurrentIndexBy(state, increaseBy) {
        return state.currentIndex - increaseBy;
    }
    /**
    ...
    function paginationClickHandler(event) {
        ...
        switch (href.substring(href.lastIndexOf("#") + 1)) {
            ...
            case "finish":
                ...
                //if (PageTitle == "UsersUpdation") {
                //    UpdateUser();
                //   // $("#DivPassword").show();
                //    //$("#DivStatus").hide();
                   
                //}
                if (PageTitle == "VehiclesRegistration") {
                    
                    FnInsertVehicle();
                }
                
                if (PageTitle == "UsersRegistration") {
                    addData();
                }
                //if (PageTitle == "VehiclesUpdation")
                //{
                //    UpdateVehicle();
                //    //$("#DivStatus").hide();
                //}
 ...
 *     });
    ...
    if ($("#PageTitle").text() == "VehiclesRegistration") {
        AllDrivers();
    }
})(jQuery);
...
function AllDrivers() {
    ...
    Selector1(param, proc).then(function (result) {
        ...
        for ($j = 0; $j < $res.length; $j++) {
            $("#DriverList").append('<span class="icheck-inline">' +
                                                    '<input type="checkbox" id=' + $res[$j].Id + ' checked="checked" class="wizard-icheck" value=' + $res[$j].Id + ' />' +
                                                    '<label for=' + $res[$j].Id + ' class="inline-label">' + $res[$j].DriverName + '</label>' +
                                                '</span>');
        }
    });
}